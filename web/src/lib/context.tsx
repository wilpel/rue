    ...
    <div className="min-h-screen flex items-center justify-center bg-bg">
      <div className="text-center p-12">
        ...
        <p className="text-text-muted text-sm">
          Start the daemon: <code className="font-mono text-accent bg-surface px-2 py-0.5 rounded text-xs">rue daemon start</code>
        </p>
      </div>
    </div>
  );
  ...
  if (!ready) return (
    <div className="min-h-screen flex items-center justify-center bg-bg">
      <div className="text-center">
        <div className="w-2 h-2 rounded-full bg-accent animate-pulse-accent mx-auto mb-4" />
