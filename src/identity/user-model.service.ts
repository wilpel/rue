...
const DEFAULT_PROFILE: UserProfile = {
  name: null, expertise: {}, preferences: [], workPatterns: [], currentProjects: [], communicationStyle: "",
};
...
export class UserModelService {
  ...
  toPromptText(): string {
    ...
    if (Object.keys(this.profile.expertise).length > 0) { lines.push("Expertise:"); for (const [area, level] of Object.entries(this.profile.expertise)) lines.push(`  - ${area}: ${level}`); }
